    ...
    <main>
      ...
      <section id="blog">
        <div class="contenido">
          ...
          <article>
            <a href="">
                <img src="assets/imagenes/biblio.jpg">
            </a>
            <h4>Biblioteca Central Pedro Zulen</h4>
          </article>
          <article>
            <a href="">
                <img src="assets/imagenes/comedor.jpg">
            </a>
            <h4>Comedor Universitario</h4>
          </article>
          <article>
            <a href="">
                <img src="assets/imagenes/clinica.jpg">
            </a>
            <h4>Clinica Universitaria</h4>
          </article>
          <article>
            <a href="">
                <img src="assets/imagenes/oca.jpg">
            </a>
            <h4>Centro Preuniversitario UNMSM</h4>
          </article>
        </div>
      </section>
